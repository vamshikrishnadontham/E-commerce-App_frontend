...
const handelClick2=()=>{
   ...
   log_sign.style.display='block';
    ...
    {/* <Link to='/profile' ><img src={profile} alt='not' height='35px'/></Link> */}
    <button onClick={handelClick2}><img src={profile} alt='not' height='35px'/></button>
     ...
     <div className="searchbar">
        ...
        <ul className="dropdown">
            ...
            <li><NavLink to= "/boatwatches">Boat </NavLink></li>
    ...
    <button onClick={handelClick}><img src={profile} alt='not' height='35px'/></button>
        ...
        <div className='profile'>
           <button onClick={handleClose}>X</button>
            ...
            <h2>< Link className='prfLink' to='/login' value={setUsername}>login</ Link></h2>
        </div>
        </div>
